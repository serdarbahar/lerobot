...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    elif name == "dual_diffusion":
        from lerobot.policies.dual_diffusion.modeling_dual_diffusion import DualDiffusionPolicy

        return DualDiffusionPolicy
    elif name == "act":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "dual_diffusion":
        return DualDiffusionConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, DualDiffusionConfig):
        from lerobot.policies.dual_diffusion.processor_dual_diffusion import make_dual_diffusion_pre_post_processors

        processors = make_dual_diffusion_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
